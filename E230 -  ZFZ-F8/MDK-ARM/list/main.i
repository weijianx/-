...
extern uint16_t AutoUpLoad_flag;
...
typedef struct
{
    ...
    uint8_t ImpDataFlag;
    RotateStaTypeDef RotateSta;
    DirectionState_TypeDef DirSta;

    uint32_t RotateSpeed;

    uint32_t PositiveTimeBase;
    uint32_t NegativeTimeBase;
...
void Led_Control(uint8_t color)
{
  if(color)
  {
    gpio_bit_write(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U),((uint32_t)((uint32_t)0x01U<<(5))),RESET);
    gpio_bit_write(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U),((uint32_t)((uint32_t)0x01U<<(6))),SET);
  ...
  {
     gpio_bit_write(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U),((uint32_t)((uint32_t)0x01U<<(6))),RESET);
     gpio_bit_write(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U),((uint32_t)((uint32_t)0x01U<<(5))),SET);
...
void GPIO_Configuration(void)
{
 rcu_periph_clock_enable(RCU_GPIOA);
    ...
    gpio_mode_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(0) << 0)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(0) << 0)), ((uint32_t)((uint32_t)0x01U<<(9))));

 gpio_output_options_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U), ((uint8_t)(0x00U)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(1) << 0)), ((uint32_t)((uint32_t)0x01U<<(9))));


    gpio_mode_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(1) << 0)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(2) << 0)), ((uint32_t)((uint32_t)0x01U<<(5))) | ((uint32_t)((uint32_t)0x01U<<(6))));

 gpio_output_options_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U), ((uint8_t)(0x00U)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(1) << 0)), ((uint32_t)((uint32_t)0x01U<<(5))) | ((uint32_t)((uint32_t)0x01U<<(6))));
...
void ZF_gpio_init(void)
{
    ...
    gpio_mode_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(0) << 0)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(0) << 0)), ((uint32_t)((uint32_t)0x01U<<(1))));
}
...
void ZF_exti_init(void)
{
    ...
    syscfg_exti_line_config(((uint8_t)0x00U), ((uint8_t)0x01U));
...
# 289 "../User/main.c"
   ...
   if(w_cnt >= 72)
   {
    ...
    usart_disable((((uint32_t)0x40000000U) + 0x00004400U));

    long32Array(UserPara.PositiveTimeBase, uTemp);

    for(j=0; j<4; j++)
    {
     total_temp[j] = uTemp[j];
    }
    long32Array(UserPara.NegativeTimeBase, uTemp);
    ...
    if(UserPara.DirSta != Stall )
    {
    UserPara.WorkTime = UserPara.PositiveTimeBase + UserPara.NegativeTimeBase + (UserPara.Duration + 30)/60;
    }
    else
    {
    UserPara.WorkTime = UserPara.PositiveTimeBase + UserPara.NegativeTimeBase ;

    }


    UserPara.WorkTime = UserPara.WorkTime/6;
    ...
    Flash_Write_MultiBytes((((((0x00 + 0x02) + 0x01) + 0x01) + 0x04) + 0x04), total_temp, 16);
    usart_enable((((uint32_t)0x40000000U) + 0x00004400U));
    }

    if(UserPara.DirSta==1)
    {
     UserPara.Duration = UserPara.PositiveTimeBase - Current_PositiveTime;
    }
    else if(UserPara.RotateSta==2)
    {
    UserPara.Duration = UserPara.NegativeTimeBase - Current_NegativeTime;
    }
    else
    {
    UserPara.Duration = (tim_1min_cnt + 30) / 60;
    }
    long32Array(UserPara.Duration, uTemp);
  ...
  if(Time_1s_flag)
  {
   ...
   Z_F_Zhuan = gpio_input_bit_get(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U),((uint32_t)((uint32_t)0x01U<<(9))));
   if(Z_F_Zhuan == 1)
   {
    Led_Control(0);
   }
   ...
   if(PulseFlag)
            {
                ...
                if(Z_F_Zhuan == 1)
                {
                    if(UserPara.DirSta == Reversal)
                    {
                        Current_PositiveTime = UserPara.PositiveTimeBase;
                        UserPara.NegativeTimeBase += (tim_1min_cnt + 30)/60;
                        tim_1min_cnt = 0;
                        tim_cnt = 0; }
                    if(UserPara.RotateSta == STA_STOP)
                    {
                        Current_PositiveTime = UserPara.PositiveTimeBase;
                        tim_1min_cnt = 0;
                          tim_cnt = 0;
                    ...
                    UserPara.DirSta = Foreward;

                    if(!((tim_cnt +1)%60))
                    {
                        UserPara.PositiveTimeBase += 1;
                        tim_1min_cnt = 0;
                    }
                }
                else
                {
                    if(UserPara.DirSta == Foreward)
                    {
                        Current_NegativeTime = UserPara.NegativeTimeBase;
                        UserPara.PositiveTimeBase += (tim_1min_cnt + 30)/60;
                        tim_1min_cnt = 0;
                        tim_cnt = 0;
                    }
                    if(UserPara.RotateSta == STA_STOP)
                    ...
                    UserPara.DirSta = Reversal;

                    if(!((tim_cnt +1)%60))
                    {
                        UserPara.NegativeTimeBase += 1;
                        tim_1min_cnt = 0;
                    }
                }

                UserPara.RotateSta = STA_WORK;
            ...
            else
            {
                ...
                UserPara.DirSta = Stall;
                UserPara.RotateSta = STA_STOP;
