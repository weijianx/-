...
uint8_t Cur_Param[(((((((((0x00 + 0x02) + 0x01) + 0x01) + 0x04) + 0x04) + 0x04) + 0x04) + 0x04) + 0x04)];


uint8_t time_tick;

uint32_t Current_pulse = 0;
uint32_t Current_PositiveTime = 0;
uint32_t Current_NegativeTime = 0;

static uint8_t User_Default_Param[(((((((((0x00 + 0x02) + 0x01) + 0x01) + 0x04) + 0x04) + 0x04) + 0x04) + 0x04) + 0x04)] =
{
 0x00,
    0x02,
    0xB1,
...
void ReadPara(void)
{
    ...
    {
        Flash_Write_MultiBytes(0x00, User_Default_Param, (((((((((0x00 + 0x02) + 0x01) + 0x01) + 0x04) + 0x04) + 0x04) + 0x04) + 0x04) + 0x04));
    }

    flash_read_multi(0x00, Cur_Param, (((((((((0x00 + 0x02) + 0x01) + 0x01) + 0x04) + 0x04) + 0x04) + 0x04) + 0x04) + 0x04));

    UserPara.SlaveAddr = Cur_Param[(0x00 + 0x02)];


    UserPara.Baudrate = Cur_Param[((0x00 + 0x02) + 0x01)];



     for(i = 0; i < 4 ;i ++)
    {
        uTemp[i] = Cur_Param[(((0x00 + 0x02) + 0x01) + 0x01) + i];
        UserPara.WorkTime += ((uint32_t)uTemp[i] << (3 - i) * 8);
    }

     for(i = 0; i < 4 ;i ++)
    {
        uTemp[i] = Cur_Param[((((((0x00 + 0x02) + 0x01) + 0x01) + 0x04) + 0x04) + 0x04) + i];
    ...
    Current_NegativeTime = UserPara.NegativeTimeBase;
     ...
     for(i = 0; i < 4 ;i ++)
    {
        uTemp[i] = Cur_Param[(((((0x00 + 0x02) + 0x01) + 0x01) + 0x04) + 0x04) + i];
    ...
    Current_PositiveTime = UserPara.PositiveTimeBase;
     ...
     for(i = 0; i < 4 ;i ++)
    {
        uTemp[i] = Cur_Param[(((((((0x00 + 0x02) + 0x01) + 0x01) + 0x04) + 0x04) + 0x04) + 0x04) + i];
...
int16_t ArrToHex(uint8_t *pData)
{
    uint16_t Data;
    Data = pData[0];
    Data <<= 8;
